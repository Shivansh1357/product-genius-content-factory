# Forge output: Kohl's
_Target: Arianne Parisi, Chief Digital Officer (started 2025). Segment: Enterprise. Platform: Custom enterprise. Engine: offline-deterministic. Source: cached whitepaper atoms. Category lift used: 34%._

## Blog post

### The next point of conversion is not on your product page. It is before it.

Most apparel teams pour their attention into the product page and the checkout. The page almost nobody optimizes is the one in between: the moment a shopper lands, scans, and silently decides whether anything here is for them. For Kohl's, declining comps and a stated mandate to fix on-site findability mean every point of digital conversion is under the microscope.

We have a number for how expensive that moment is. In controlled A/B tests, adapting to each shopper in real time delivered this: a 36 percent average lift in revenue per session across 25 brands and millions of sessions. In apparel specifically, the lift averaged 34 percent. That is the same traffic and the same catalog, converting more of the people already on the page.
...
Picture the homepage reading the room for Kohl's: a shopper lands, the feed opens on what they came for, then reorders itself with every swipe, surfacing the next best product and the answer to the question they have not typed yet. Declining comps and a stated mandate to fix on-site findability mean every point of digital conversion is under the microscope is, not coincidentally, exactly the kind of problem that gets cheaper when the page learns in real time instead of in quarters. The product page and the checkout are mostly solved. The expensive, unoptimized middle is where the next 34 percent is sitting.
...
Fair instinct, and for a team like Kohl's's, a real option. So here is the honest version.
...
Declining comps and a stated mandate to fix on-site findability mean every point of digital conversion is under the microscope.
...
For Kohl's, discovery is the moat. Most teams just have not pointed their best technology at it yet.
...
You stepped into a clear mandate: fix findability and lift digital conversion while comps are under pressure. That is a revenue-per-session problem, and it is measurable.

We built an AI that turns the few seconds after a shopper lands into a feed that adapts as they scroll, surfacing the next best product instead of making them dig. In controlled A/B tests, the headline result was this: a 36 percent average lift in revenue per session across 25 brands and millions of sessions. In apparel specifically, the lift averaged 34 percent.
...
Worth fifteen minutes to show you what it would look like on a Kohl's page?
...
We ran randomized A/B tests: half of traffic saw the normal site, half saw the same site with our feed added. We measured revenue per session, and we averaged the lift across every day of the test, not just the strong days at the end, so the number is conservative. Apparel brands averaged 34 percent.
...
If now is not the moment, no problem, and I will stop landing in your inbox. If you want to see it on a real Kohl's page first, reply with a time and I will bring the mockup.
